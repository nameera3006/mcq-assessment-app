...
<!-- This marks the jsp for generation of otp i.e. send via email for login verification -->
...
<html>
    ...
    <body>
     <%
            ...
            String from = "nameerafshaikh@gmail.com";
						...
						//host set
								...
								Session s=Session.getInstance(properties, new Authenticator() {
									...
									protected PasswordAuthentication getPasswordAuthentication() {				
										return new PasswordAuthentication("nameerafshaikh@gmail.com", "@ABC123xyz");
									}
